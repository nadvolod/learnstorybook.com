...
const { twitter, chat, youtube, navLinks = {}, tutorials, gitHub = {} } = urls;
  ...
  <FooterWrapper {...props}>
    <Upper>
      ...
      <UpperColumn>
        <Resources>
          <Resource>
            <img src="/direction.svg" alt="Tutorial" />
            <Meta>
    ...
    <Lower>
      <Colophon>
        <LogotypeWrapper isGatsby to="/">
          <img src="/storybook-logo.svg" alt="Storybook" />
        </LogotypeWrapper>
        <Text>
    ...
    <Services>
      <Service>
        ...
        <a href="https://netlify.com">
          <Netlify src="/logo-netlify.svg" alt="Netlify" />
        </a>
      </Service>
      <Service>
        <Text>Visual testing by</Text>
        <a href="https://www.chromatic.com/">
          <Chromatic src="/icon-chroma.svg" alt="Chromatic" />
        </a>
      </Service>
      <Service>
        <Text>Continuous integration by</Text>
        <a href="https://circleci.com/">
          <CircleCI src="logo-circleci.svg" alt="CircleCI" />
        </a>
      </Service>
    </Services>
  </FooterWrapper>
